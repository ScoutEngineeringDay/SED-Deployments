...
sudo docker build --tag sed_kickoff:latest /ansible/SED-Documentations/presentations/SED-Presentation1-Kick-Off/
...
sudo docker build --tag sed_tech:latest /ansible/SED-Documentations/presentations/SED-Presentation2-Technologies/
...
sudo docker build --tag sed_training:latest /ansible/SED-Documentations/presentations/SED-Presentation3-Training/
...
sudo docker build --tag sed_overview:latest /ansible/SED-Documentations/presentations/SED-Presentation4-Overview/
